...
export const BarangayMapPage = () => {
  ...
  return (
    <Card title="Santa Rosa City Barangay Map" className="space-y-4">
      <p className="text-sm">
        Using Google Maps for live map data. Select a barangay to view its pinned location in
      ...
      <div className="grid gap-3 md:grid-cols-[1fr,320px]">
        ...
        <div className="space-y-3 border-2 border-black bg-white p-3">
          ...
          <div className="space-y-1 border-2 border-black bg-zinc-50 p-2">
            <p className="text-xs uppercase tracking-wide font-semibold">SPES Leader</p>
            {isDirectoryLoading ? (
            ...
            {selectedBarangayCoLeaders.length > 0 ? (
              <div className="space-y-1 pt-1">
                <p className="text-xs">
                  Co-Leader{selectedBarangayCoLeaders.length > 1 ? 's' : ''}
                </p>
